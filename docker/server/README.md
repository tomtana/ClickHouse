...
- The arm64 image requires support for the [ARMv8.3-A architecture](https://en.wikipedia.org/wiki/AArch64#ARMv8.3-A) which is currently not supported by many CPUs. Famous examples for not supported devices are Raspberry Pi 4 (ARMv8.0-A) and Nvidia Jetson AGX Xavier/Orin (ARMv8.2-A).
